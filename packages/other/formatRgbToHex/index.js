 ...
 * @FilePath: \configjs-utilsjs\packages\other\formatRgbToHex\index.js
 * @Author: FYR
 * @Date: 2023-05-09 11:09:18
 * @LastEditors: FYR
 * @LastEditTime: 2023-05-09 14:30:03
...
export default function formatRgbToHex(r, g, b) {
    ...
    if (isNumber(r) && isNumber(g) && isNumber(b)) {
		...
		console.error('Uncaught TypeError: r or g or b is not a number in transformingRgbToHex(r, g, b)');
        return '';
    }
}
